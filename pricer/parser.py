""" This code takes messy raw product data, cleans and filters it, extracts useful information such as weight, 
and converts it into standardized Item objects for the price-prediction model.
