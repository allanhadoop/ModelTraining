# It takes a predictor, asks it to predict prices for 200 products, 
# compares those predictions with the real prices, and produces statistics + charts showing how accurate it was.
